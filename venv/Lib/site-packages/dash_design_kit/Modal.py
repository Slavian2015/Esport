...
- className (string; default ''): The optional className of the component
...
- style (dict; optional): Overrides the default (inline) styles for the this component."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, cardRef=Component.UNDEFINED, target_id=Component.UNDEFINED, width=Component.UNDEFINED, height=Component.UNDEFINED, hide_target=Component.UNDEFINED, expanded=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'cardRef', 'target_id', 'width', 'height', 'hide_target', 'expanded', 'setProps', 'style']
        self._type = 'Modal'
        self._namespace = 'dash_design_kit'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'cardRef', 'target_id', 'width', 'height', 'hide_target', 'expanded', 'setProps', 'style']
